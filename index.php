	       ...
	       <header class="header">
                ...
                <section>
                    <div style="background: none" class="banner">
                        <div class="center"><img alt="" src="img/fondo.jpg"></div>
                    </div>
                </section>
		    </header>
            ...
            <div class="center">
                <div>
                    <ul class="breadcrumbs">
                        ...
                        <li><span><em>Consulta Tramite</em></span></li>
                    </ul>
                </div>	
                    ...
                    <div id="id55">
                        ...
                        <form id="id56" name="formu" action="" method="post" class="form_box form">
                            ...
                            <p class="fields">
                                ...
                                <span class="field">
                                    <input type="text" name="txtNumeroExpediente" class="form-control" placeholder="ingrese numero de expediente o de documento" required>
                                </span>
                            </p>
